...
Intensitäten(K.Intensität_alle_jit_fürMinimierung([0.1, 0.9]))
Intensitäten(K.Intensität_alle_jit_fürMinimierung([0.9, 0.1]))
#print(K.Intensität_K_alle_jit_fürMinimierung([1,1]))
Intensitäten(K.Intensität_alle_jit_fürMinimierung([1.0, 1.0]))

K = Calc_I(Element_Probe=30, Konzentration=[1,1,1], P1 = ["H","o","Cu"], Messzeit=300, Emax=30)
Intensitäten(K.Intensität_alle_jit_fürMinimierung([0.00, 0.00, 1.0]))
Intensitäten(K.Intensität_alle_jit_fürMinimierung([0.1, 0.00, 0.9]))
Intensitäten(K.Intensität_alle_jit_fürMinimierung([0.9, 0.00, 0.1]))
Intensitäten(K.Intensität_alle_jit_fürMinimierung([0.05, 0.05, 0.9]))
Intensitäten(K.Intensität_alle_jit_fürMinimierung([0.45, 0.45, 0.1]))
