...
Geo =7e-05
#print((K.Intensität_K_alle_jit_fürMinimierung(op_Konz)*Geo).astype(int))
Int = ((K.Intensität_alle_jit_fürMinimierung(op_Konz) * Geo).astype(int))
print((K.Intensität_alle_jit_fürMinimierung(op_Konz) * Geo * (139924 / Int[2])).astype(int))
Int = ((K.Intensität_alle_jit_fürMinimierung(op_Konz) * Geo).astype(int))
print((K.Intensität_alle_jit_fürMinimierung(op_Konz) * Geo * (187433 / Int[3])).astype(int))
...
print("berechnete Intensitäten", (K.Intensität_alle_jit_fürMinimierung(op_Konz) * op_Geo).astype(int))
print("sollintensitäten [0, 0, 139924, 187433]")
